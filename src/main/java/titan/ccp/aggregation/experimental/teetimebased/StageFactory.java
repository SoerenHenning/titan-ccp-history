...
public class StageFactory {
  ...
  public static <T, O> AbstractProducerStage<O> producer(
      final Function<Consumer<O>, T> logicFactory, final Function<T, Procedure> method) {
  ...
  public static <T, I> AbstractConsumerStage<I> consumer(final T logic,
  ...
  public static <T, I, O> AbstractTransformation<I, O> transformation(
      final Function<Consumer<O>, T> logicFactory, final Function<T, Consumer<I>> method) {
  ...
  public static void main(final String[] args) {
    ...
    // w::println);
    final AbstractConsumerStage<String> consumer =
        StageFactory.consumer(new PrintWriter(System.out), w -> (final String s) -> w.println(s));
