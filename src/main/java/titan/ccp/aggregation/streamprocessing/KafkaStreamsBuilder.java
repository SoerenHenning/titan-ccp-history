...
public class KafkaStreamsBuilder {
	...
	private Topology buildTopology() {
		...
		final KTable<String, AggregationHistory> aggregated = groupedStream.aggregate(() -> new AggregationHistory(),
		...
		final CassandraWriter cassandraWriter = this.buildCassandraWriter(AggregatedActivePowerRecord.class);
		...
		final CassandraWriter cassandraWriterForNormal = this.buildCassandraWriter(ActivePowerRecord.class);
	...
	private CassandraWriter buildCassandraWriter(final Class<? extends IMonitoringRecord> recordClass) {
